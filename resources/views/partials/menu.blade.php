        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('product.shoppingCart') }}"><i
                    ...
                    <span
                        class="badge badge-pill badge-primary">{{ Session::has('cart') ? Session::get('cart')->totalQty : '0' }}</span></a>
            </li>
            @auth
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user.wishlist') }}"><i
                        ...
                        <span
                        class="badge badge-pill badge-primary">{{ Auth::user()->wishlist->sum('qty') }}</span> </a>
            </li>
